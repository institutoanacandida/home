            ...
            <div class="footer-grid">
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 1.2rem;">
                        ...
                        <li style="display: flex; align-items: flex-start; gap: 0.75rem; color: #FDFBFA !important; opacity: 0.9;"><i data-lucide="mail" style="width: 18px; height: 18px; flex-shrink: 0; margin-top: 0.2rem;"></i><span style="word-break: break-all;">Nikolly.ana12@gmail.com</span></li>
                    </ul>
                </div>
                <!-- Col 4: Legal -->
                <div>
