...
function Get-Header($depthPath) {
    ...
    <div id="mobile-menu" class="hidden" style="position: fixed; inset: 0; background: white; z-index: 2000; padding: 2rem; display: none; flex-direction: column; overflow-y: auto;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem;">
            <a href="${depthPath}o-instituto" style="font-weight: 600; color: #483525; text-decoration: none; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">O Instituto</a>
            <a href="${depthPath}terapia-sistemica" style="font-weight: 600; color: #483525; text-decoration: none; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">Terapia Sistêmica</a>
            <a href="${depthPath}atendimentos" style="font-weight: 600; color: #483525; text-decoration: none; padding: 0.5rem 0; border-bottom: 1px solid #f0f0f0;">Atendimentos</a>
            <a href="${depthPath}equipe" style="color: #483525; text-decoration: none; padding: 0.5rem 0;">Equipe</a>
            <a href="${depthPath}galeria" style="color: #483525; text-decoration: none; padding: 0.5rem 0;">Galeria</a>
            <a href="${depthPath}conteudos" style="color: #483525; text-decoration: none; padding: 0.5rem 0;">Conteúdos</a>
            <a href="${depthPath}contato" style="color: #483525; text-decoration: none; padding: 0.5rem 0;">Contato</a>
