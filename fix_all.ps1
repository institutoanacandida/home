...
function Get-StyleBlock {
    ...
    <style id="global-styles">
        ...
        @media (max-width: 767px) {
            ...
            .footer-grid > div { align-items: flex-start !important; }
            ...
            .footer-grid > div:nth-child(1) p { margin-left: auto; margin-right: auto; }
            
            .footer-grid ul { align-items: flex-start !important; }
            .footer-grid li { justify-content: flex-start !important; text-align: left !important; }
            
            /* Compact text for Aviso on mobile */
            .footer-grid > div:nth-child(5) p { font-size: 0.8rem !important; }
        }
