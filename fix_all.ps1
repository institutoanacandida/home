...
function Get-StyleBlock {
    ...
    <style id="global-styles">
        ...
        @media (min-width: 1024px) {
            .footer-grid { grid-template-columns: 0.8fr 0.6fr 1.5fr 2fr 2.4fr; gap: 2rem; }
        ...
        .btn-bio-card { 
            ...
            border: 1px solid #C19555 !important; 
        ...
        .btn-bio-card:hover { transform: translateY(-3px) !important; background: #FFFFFF !important; box-shadow: 0 10px 20px rgba(193, 149, 85, 0.1) !important; border-color: #0A4834 !important; }
        .btn-bio-label { font-weight: 700; color: #0A4834 !important; font-size: 1.1rem; margin-bottom: 0.25rem; }
        .btn-bio-subtext { font-size: 0.85rem; color: #C19555 !important; opacity: 0.9; }
        ...
        <nav class="container-custom" style="padding: 0 2rem;">
            <div style="display: flex; align-items: center; width: 100%; justify-content: space-between; height: 110px;">
                <a href="$depthPath" style="display: flex; align-items: center; text-decoration: none; height: 100%;">
                    <img src="https://i.ibb.co/vvPV65rT/ana-candida-s-f.png" alt="Instituto Ana C&acirc;ndida" style="height: 95px; width: auto; object-fit: contain;">
                </a>
                
                <div class="hidden lg:flex items-center" style="gap: 2.2rem; height: 100%;">
                    <a href="${depthPath}" style="font-size: 0.9rem; font-weight: 500; color: #0A4834; text-decoration: none; font-family: 'Montserrat', sans-serif;">In&iacute;cio</a>
                    
                    <!-- O Instituto Dropdown -->
                    <div class="nav-item-dropdown">
                        <span class="nav-link-main">O Instituto <i data-lucide="chevron-down" class="chevron-icon"></i></span>
                        <div class="dropdown-menu">
                            <a href="${depthPath}o-instituto" class="dropdown-item">Vis&atilde;o Geral</a>
                            <a href="${depthPath}o-instituto#sobre" class="dropdown-item">Sobre n&oacute;s</a>
                            <a href="${depthPath}o-instituto#missao" class="dropdown-item">Miss&atilde;o e Valores</a>
                            <a href="${depthPath}o-instituto#como-trabalhamos" class="dropdown-item">Como Trabalhamos</a>
                        </div>
                    </div>

                    <!-- Terapia Sist&ecirc;mica Dropdown -->
                    <div class="nav-item-dropdown">
                        <span class="nav-link-main">Terapia Sist&ecirc;mica <i data-lucide="chevron-down" class="chevron-icon"></i></span>
                        <div class="dropdown-menu">
                            <a href="${depthPath}terapia-sistemica" class="dropdown-item">Vis&atilde;o Geral</a>
                            <a href="${depthPath}terapia-sistemica#que-e" class="dropdown-item">O que &eacute;</a>
                            <a href="${depthPath}terapia-sistemica#para-quem" class="dropdown-item">Para quem &eacute;</a>
                            <a href="${depthPath}terapia-sistemica#primeira-sessao" class="dropdown-item">Primeira Sess&atilde;o</a>
                        </div>
                    </div>
                    ...
                    <a href="${depthPath}conteudos" style="display:none;">Conte&uacute;dos</a>
                    <!-- Conte&uacute;dos Dropdown -->
                    <div class="nav-item-dropdown">
                        <span class="nav-link-main">Conte&uacute;dos <i data-lucide="chevron-down" class="chevron-icon"></i></span>
                        <div class="dropdown-menu">
                            <a href="${depthPath}conteudos" class="dropdown-item">Vis&atilde;o Geral</a>
                            ...
                            <a href="${depthPath}conteudos/formacao" class="dropdown-item">Forma&ccedil;&atilde;o</a>
                        </div>
                    </div>
    ...
    <div id="mobile-menu" class="hidden" style="position: fixed; inset: 0; background: white; z-index: 2000; padding: 2rem; flex-direction: column; overflow-y: auto;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
            <a href="$depthPath" style="display: flex; align-items: center; text-decoration: none; margin-bottom: 1rem;">
                <img src="https://i.ibb.co/vvPV65rT/ana-candida-s-f.png" alt="Instituto Ana C&acirc;ndida" style="height: 75px; width: auto; object-fit: contain;">
            </a>
        ...
        <div style="display: flex; flex-direction: column;">
            <a href="${depthPath}" style="font-weight: 600; color: #0A4834; text-decoration: none; padding: 1.25rem 0; border-bottom: 1px solid #f0f0f0; font-family: 'Montserrat', sans-serif;">In&iacute;cio</a>
            ...
            <div class="mobile-nav-item">
                ...
                <div class="mobile-nav-content">
                    <a href="${depthPath}o-instituto" class="mobile-link-sub">Vis&atilde;o Geral</a>
                    <a href="${depthPath}o-instituto#sobre" class="mobile-link-sub">Sobre n&oacute;s</a>
                    <a href="${depthPath}o-instituto#missao" class="mobile-link-sub">Miss&atilde;o e Valores</a>
                    <a href="${depthPath}o-instituto#como-trabalhamos" class="mobile-link-sub">Como Trabalhamos</a>
                </div>
            </div>

            <!-- Terapia Sist&ecirc;mica Mobile -->
            <div class="mobile-nav-item">
                <button class="mobile-nav-btn" onclick="toggleMobileAccordion(this)">
                    Terapia Sist&ecirc;mica <i data-lucide="chevron-down" class="chevron-mobile" style="width: 18px; height: 18px;"></i>
                </button>
                <div class="mobile-nav-content">
                    <a href="${depthPath}terapia-sistemica" class="mobile-link-sub">Vis&atilde;o Geral</a>
                    <a href="${depthPath}terapia-sistemica#que-e" class="mobile-link-sub">O que &eacute;</a>
                    <a href="${depthPath}terapia-sistemica#para-quem" class="mobile-link-sub">Para quem &eacute;</a>
                    <a href="${depthPath}terapia-sistemica#primeira-sessao" class="mobile-link-sub">Primeira Sess&atilde;o</a>
                </div>
            </div>
            ...
            <!-- Conte&uacute;dos Mobile -->
            <div class="mobile-nav-item">
                <button class="mobile-nav-btn" onclick="toggleMobileAccordion(this)">
                    Conte&uacute;dos <i data-lucide="chevron-down" class="chevron-mobile" style="width: 18px; height: 18px;"></i>
                </button>
                <div class="mobile-nav-content">
                    <a href="${depthPath}conteudos" class="mobile-link-sub">Vis&atilde;o Geral</a>
                    ...
                    <a href="${depthPath}conteudos/formacao" class="mobile-link-sub">Forma&ccedil;&atilde;o</a>
                </div>
            </div>
            ...
            <div class="footer-grid">
                ...
                <div>
                    <a href="${depthPath}" style="display: block; margin-bottom: 1.5rem;">
                        <img src="https://i.ibb.co/pBFQK4ZY/Design-sem-nome-64.png" alt="Instituto Ana C&acirc;ndida" style="height: 70px; width: auto; object-fit: contain;">
                    </a>
                    <p style="opacity: 0.9; line-height: 1.6; margin-bottom: 2rem; font-size: 0.95rem; color: #FDFBFA !important;">Cuidado relacional com base na Terapia Sist&ecirc;mica. Acolhimento, &eacute;tica e ci&ecirc;ncia para casais e fam&iacute;lias.</p>
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.8rem;">
                        <li><a href="${depthPath}o-instituto" style="color: #FDFBFA !important; text-decoration: none; opacity: 0.8;">Sobre n&oacute;s</a></li>
                        <li><a href="${depthPath}equipe" style="color: #FDFBFA !important; text-decoration: none; opacity: 0.8;">Equipe</a></li>
                        <li><a href="${depthPath}atendimentos" style="color: #FDFBFA !important; text-decoration: none; opacity: 0.8;">Servi&ccedil;os</a></li>
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 1.2rem;">
                        <li style="display: flex; align-items: flex-start; gap: 0.75rem; color: #FDFBFA !important; opacity: 0.9;"><i data-lucide="map-pin" style="width: 18px; height: 18px; flex-shrink: 0; margin-top: 0.2rem;"></i><span>Village, Goi&acirc;nia-GO</span></li>
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.8rem;">
                        ...
                        <li><a href="${depthPath}termos#politica" class="footer-nowrap" style="color: #FDFBFA !important; text-decoration: none; opacity: 0.8;">Pol&iacute;tica de Remarca&ccedil;&atilde;o</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p style="opacity: 0.9; line-height: 1.6; font-size: 0.9rem; color: #FDFBFA !important;">Este site n&atilde;o oferece atendimento de emerg&ecirc;ncia. Em caso de crise, procure o hospital mais pr&oacute;ximo ou ligue <span style="color: var(--red-accent); font-weight: 700;">188 (CVV)</span>.</p>
                </div>
            </div>
            <div style="border-top: 1px solid rgba(253, 251, 250, 0.1); padding-top: 2rem; text-align: center;">
                <p style="opacity: 0.7; font-size: 0.875rem; color: #FDFBFA !important;">&copy; 2026 Instituto Ana C&acirc;ndida. Todos os direitos reservados.</p>
            </div>
        </div>
    </footer>
    <!-- FOOTER_END -->
...
"@
        [System.IO.File]::WriteAllText($path, $newContent.Trim(), [System.Text.UTF8Encoding]::new($false))
    }
}
