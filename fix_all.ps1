...
function Get-StyleBlock {
    ...
    <style id="global-styles">
        ...
        /* Responsive & Framed Footer Grid */
        .footer-grid { 
            display: grid; grid-template-columns: 1fr; gap: 3rem; margin-bottom: 4rem; text-align: center;
        }
        ...
        @media (min-width: 1024px) {
            .footer-grid { grid-template-columns: 1.5fr 1fr 1.6fr 1.4fr 1.8fr; gap: 3rem; }
        ...
        @media (max-width: 767px) {
            ...
            /* Hybrid Footer Mobile Grid (1 full + 2 pairs) */
            .footer-grid { 
            ...
            .footer-grid > div { 
                ...
                min-width: 0; /* Prevents flex/grid items from stretching */
            }
            ...
            .footer-grid > div:nth-child(1) p { margin-left: auto; margin-right: auto; max-width: 280px; }
            
            .footer-grid h4 { font-size: 1rem !important; margin-bottom: 1rem !important; }
            .footer-grid ul { align-items: flex-start !important; }
            .footer-grid li { justify-content: flex-start !important; text-align: left !important; font-size: 0.85rem !important; }
            .footer-grid a { overflow-wrap: anywhere !important; word-break: break-word !important; }
            
            /* Compact text for Aviso on mobile */
            .footer-grid > div:nth-child(5) p { font-size: 0.75rem !important; line-height: 1.4 !important; }
            
            /* Force padding safety */
            .container-custom { padding: 0 1.25rem !important; }
        }
        ...
        .filter-btn:hover {
            ...
            background: rgba(193, 149, 85, 0.05);
        }
        .filter-btn.active {
            background: var(--brand-900);
            color: white !important;
            border-color: var(--brand-900);
            box-shadow: 0 10px 15px -3px rgba(10, 72, 52, 0.2);
        }
        ...
        .lightbox-img { width: 100%; height: 100%; object-fit: contain; border-radius: 1rem; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5); }
        .lightbox-close { position: absolute; top: -3rem; right: 0; color: white; background: none; border: none; font-size: 2.5rem; cursor: pointer; }
        .lightbox-caption { color: white; margin-top: 1.5rem; text-align: center; font-family: 'Montserrat', sans-serif; font-size: 1.1rem; }

        /* Dynamic Feed Skeleton */
        .skeleton-card {
            background: white; border-radius: 1.5rem; padding: 0; overflow: hidden;
            border: 1px solid #eee; display: flex; flex-direction: column; height: 100%;
        }
        .skeleton-img { width: 100%; height: 240px; background: linear-gradient(90deg, #f0f0f0 25%, #f8f8f8 50%, #f0f0f0 75%); background-size: 200% 100%; animation: skeleton-pulse 1.5s infinite; margin-bottom: 1.5rem; }
        .skeleton-line { height: 12px; background: #f0f0f0; margin: 0 1.5rem 0.8rem; border-radius: 4px; animation: skeleton-pulse 1.5s infinite; }
        ...
        .btn-bio-card { background: white !important; border: 1px solid var(--brand-100) !important; padding: 1.5rem !important; border-radius: 1.25rem !important; text-decoration: none !important; display: flex !important; flex-direction: column !important; align-items: center !important; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1) !important; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05) !important; width: 100% !important; margin-bottom: 1.2rem !important; }
        .btn-bio-card:hover { transform: translateY(-4px) !important; border-color: var(--brand-500) !important; box-shadow: 0 20px 25px -5px rgba(72,53,37,0.1) !important; }
        ...
        .value-item-bio:hover { border-color: var(--brand-500); transform: translateY(-2px); }

        /* Lead Capture Modal Styles */
        .modal-overlay { display: none; position: fixed; inset: 0; background: rgba(72, 53, 37, 0.6); backdrop-filter: blur(8px); z-index: 3000; align-items: center; justify-content: center; padding: 1rem; }
        .modal-content { background: white; padding: 3rem; border-radius: 2rem; max-width: 480px; width: 100%; position: relative; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); }
        .modal-close { position: absolute; top: 1.5rem; right: 1.5rem; background: none; border: none; font-size: 1.5rem; cursor: pointer; color: var(--brand-500); }
        .modal-title { font-family: 'Playfair Display', serif; font-size: 1.75rem; color: var(--brand-900); margin-bottom: 1rem; }
        .modal-text { color: var(--brand-800); opacity: 0.8; margin-bottom: 2rem; font-size: 0.95rem; }
...
function Get-Header($depthPath) {
        ...
        <nav class="container-custom" style="padding: 0 2rem;">
            <div style="display: flex; align-items: center; width: 100%; justify-content: space-between; height: 110px;">
                ...
                <div class="hidden lg:flex items-center" style="gap: 2.2rem; height: 100%;">
                    <a href="${depthPath}" style="font-size: 0.9rem; font-weight: 500; color: #0A4834; text-decoration: none; font-family: 'Montserrat', sans-serif;">Início</a>
                ...
                <div class="hidden lg:block" style="position: relative;">
                    <a href="https://wa.me/5562994718809" target="_blank" class="btn-primary" style="padding: 0.6rem 1.5rem; font-size: 0.85rem;">Agendar</a>
    ...
    <div id="mobile-menu" class="hidden" style="position: fixed; inset: 0; background: white; z-index: 2000; padding: 2rem; flex-direction: column; overflow-y: auto;">
        ...
        <div style="display: flex; flex-direction: column;">
            <a href="${depthPath}" style="font-weight: 600; color: #0A4834; text-decoration: none; padding: 1.25rem 0; border-bottom: 1px solid #f0f0f0; font-family: 'Montserrat', sans-serif;">Início</a>
            ...
            <a href="https://wa.me/5562994718809" target="_blank" style="background-color: #0A4834; color: white; padding: 1rem; border-radius: 0.75rem; text-align: center; text-decoration: none; font-weight: 600; margin-top: 2rem; font-family: 'Montserrat', sans-serif;">Agendar Agora</a>
        </div>
    </div>
    <!-- Header End -->
"@
        ...
        <div class="container-custom">
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <p style="opacity: 0.9; line-height: 1.6; margin-bottom: 2rem; font-size: 0.95rem; color: #FDFBFA !important; max-width: 300px;">Cuidado relacional com base na Terapia Sistêmica. Acolhimento, ética e ciência para casais e famílias.</p>
                    <div style="display: flex; gap: 1.5rem; align-items: center; justify-content: inherit;">
                ...
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 1.2rem;">
                        ...
                        <li style="display: flex; align-items: center; gap: 0.75rem; color: #FDFBFA !important; opacity: 0.9;"><i data-lucide="phone" style="width: 18px; height: 18px; flex-shrink: 0;"></i><span>(62) 99471-8809</span></li>
                        <li style="display: flex; align-items: flex-start; gap: 0.75rem; color: #FDFBFA !important; opacity: 0.9;"><i data-lucide="mail" style="width: 18px; height: 18px; flex-shrink: 0; margin-top: 0.2rem;"></i><span class="footer-nowrap">institutoanacandida@gmail.com</span></li>
                    </ul>
                </div>
                <!-- Col 4: Legal -->
                <div>
                    ...
                    <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.8rem;">
                        ...
                        <li><a href="${depthPath}termos#politica" class="footer-nowrap" style="color: #FDFBFA !important; text-decoration: none; opacity: 0.8;">Política de Remarcação</a></li>
                    </ul>
                </div>
                <!-- Col 5: Aviso Important -->
                <div>
                    <h4 style="font-family: 'Playfair Display', serif; font-size: 1.1rem; margin-bottom: 1.5rem; font-weight: 700; color: #FDFBFA !important; display: flex; align-items: center; gap: 0.5rem; justify-content: inherit;">
                        <span style="width: 8px; height: 8px; background-color: var(--red-accent); border-radius: 50%; display: inline-block;"></span> 
                        Aviso Importante
                    </h4>
                    <p style="opacity: 0.9; line-height: 1.6; font-size: 0.9rem; color: #FDFBFA !important; max-width: 320px;">Este site não oferece atendimento de emergência. Em caso de crise, procure o hospital mais próximo ou ligue <span style="color: var(--red-accent); font-weight: 700;">188 (CVV)</span>.</p>
                </div>
            </div>
    ...
    <script>
        ...
        function openLightbox(index) {
            ...
            if(lightbox && lbImg) {
                ...
                lbCap.innerText = target.getAttribute('data-caption');
        ...
        /* Dynamic Feed Fetcher - Resilient Version */
        async function fetchDynamicFeed() {
            const container = document.getElementById('dynamic-feed');
            if(!container) return;
            
            // Only render skeleton if container is empty (Resilience for static fallback)
            const isInitialLoad = !container.querySelector('article');
            if(isInitialLoad) {
            ...
            const rssUrl = 'https://amenteemaravilhosa.com.br/feed/';
            const apiUrl = `https://api.rss2json.com/v1/api.json?rss_url=${encodeURIComponent(rssUrl)}`;

            const timeout = setTimeout(() => {
                if(container.innerHTML.includes('skeleton-card')) {
                    container.innerHTML = '<div style="grid-column: 1/-1; text-align: center; padding: 3rem; background: #fcfcfc; border-radius: 2rem;">' +
                        '<p style="color: #666; margin-bottom: 1rem;">O portal de notícias está demorando a responder...</p>' +
                        '<button onclick="location.reload()" class="btn btn-primary" style="padding: 0.5rem 1.5rem; font-size: 0.9rem;">Tentar novamente</button></div>';
                }
            }, 10000);
            ...
            try {
                ...
                if (data.status === 'ok') {
                    ...
                    data.items.slice(0, 3).forEach(item => {
                        ...
                        article.style.cssText = 'display: flex; flex-direction: column; cursor: pointer; transition: all 0.3s ease;';
                        article.onclick = () => window.open(item.link, '_blank');
                        
                        const date = new Date(item.pubDate).toLocaleDateString('pt-BR', { day: '2-digit', month: 'short', year: 'numeric' });
                        const category = (item.categories && item.categories.length > 0) ? item.categories[0] : 'Bem-estar';
                        ...
                        if(!thumb) thumb = 'https://images.unsplash.com/photo-1499209974431-9dac3adaf471?q=80&w=1200';

                        article.innerHTML = `
                            <div style="width: 100%; height: 240px; border-radius: 1.5rem; overflow: hidden; margin-bottom: 2rem; background: #eee; position: relative;">
                                <img src="${thumb}" alt="${item.title}" style="width: 100%; height: 100%; object-fit: cover; transition: transform 0.6s cubic-bezier(0.4, 0, 0.2, 1); opacity: 0; transition: opacity 0.5s ease-in-out;" onload="this.style.opacity='1'" onmouseover="this.style.transform='scale(1.08)'" onmouseout="this.style.transform='scale(1)'">
                            </div>
                            <div style="display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1rem; font-size: 0.85rem;">
                                <span style="background: var(--brand-100); color: var(--brand-600); padding: 0.25rem 0.75rem; border-radius: 1rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">${category}</span>
                                <span style="color: #666; font-weight: 500;">• ${date}</span>
                            </div>
                            <h3 style="font-size: 1.4rem; color: var(--brand-900); margin-bottom: 1rem; line-height: 1.35; font-weight: 700; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">${item.title}</h3>
                            <p style="color: #666; line-height: 1.6; margin-bottom: 1.5rem; font-size: 0.95rem; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden;">${item.description.replace(/<[^>]*>?/gm, '').substring(0, 150)}...</p>
                            <div style="margin-top: auto; display: flex; align-items: center; gap: 0.5rem; color: var(--brand-500); font-weight: 700; font-size: 0.9rem;">
                                Ler na fonte <i data-lucide="external-link" style="width: 14px; height: 14px;"></i>
                            </div>
                        `;
                ...
                container.innerHTML = '<p style="grid-column: 1/-1; text-align: center; color: #666; padding: 2rem;">Não foi possível carregar as notícias agora. <a href="javascript:location.reload()" style="color: var(--brand-500);">Clique aqui para tentar novamente.</a></p>';
            }
        }
        document.addEventListener('DOMContentLoaded', fetchDynamicFeed);
    </script>
    <!-- SCRIPTS_END -->
"@
    if ($hasLocalScript) {
